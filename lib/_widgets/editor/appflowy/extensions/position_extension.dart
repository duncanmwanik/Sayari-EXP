...
extension PositionExtension on Position {
  ...
  Position? moveVertical(
    ...
    final nodeConfig = editorState.service.rendererService.blockComponentBuilder(node.type)?.configuration;
    if (nodeConfig == null) {
    ...
    for (double y = minFontSize; y < remainingMultilineHeight + minFontSize; y += minFontSize) {
    ...
    final maxSkip = upwards ? padding.top + globalVerticalPadding : padding.bottom + globalVerticalPadding;
