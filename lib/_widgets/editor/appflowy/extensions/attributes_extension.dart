...
extension NodeAttributesExtensions on Attributes {
  ...
  num? get number {
    if (containsKey(BuiltInAttributeKey.number) && this[BuiltInAttributeKey.number] is num) {
  ...
  bool get check {
    if (containsKey(BuiltInAttributeKey.checkbox) && this[BuiltInAttributeKey.checkbox] is bool) {
