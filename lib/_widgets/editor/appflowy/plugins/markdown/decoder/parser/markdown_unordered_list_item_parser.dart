...
class MarkdownUnorderedListItemParserV2 extends CustomMarkdownParser {
  ...
  List<Node> transform(
    ...
    if (element.tag != 'li' || element.attributes.isNotEmpty || listType != MarkdownListType.unordered) {
      return [];
    }
    ...
    final deltaNodes = sliceIndex == -1 ? element.children : element.children!.slice(0, sliceIndex);
