...
class PdfHTMLEncoder {
  ...
  (pw.TextAlign?, pw.TextStyle) _parserFormattingElementAttributes(
    ...
    final localName = element.localName;
    pw.TextAlign? textAlign;
    pw.TextStyle attributes = pw.TextStyle(fontFallback: fontFallback, font: font);
    ...
    switch (localName) {
      ...
      case HTMLTags.underline:
        ...
        break;
      case HTMLTags.del:
        attributes = attributes.copyWith(decoration: pw.TextDecoration.lineThrough);
        break;
      /*
    ...
    return (textAlign, attributes.copyWith(decoration: pw.TextDecoration.combine(decoration)));
  }
  ...
  Iterable<pw.Widget> _parseUnOrderListElement(dom.Element element) {
    final findTodos = element.children.where((element) => element.text.contains('['));
  ...
  pw.Widget _parseListElement(
    ...
    if (type == TodoListBlockKeys.type) {
      ...
      final strippedString = element.text.substring(bracketRightIndex, element.text.length);
  ...
  (pw.TextAlign?, pw.TextStyle) _getDeltaAttributesFromHTMLAttributes(
    ...
    if (backgroundColor != null) {
      ...
      if (highlightColor != null) {
        style = style.copyWith(background: pw.BoxDecoration(color: highlightColor));
      }
    }
