      ...
      children: [
        MouseRegion(
          ...
          child: Container(
            constraints: BoxConstraints(
              minHeight: context.select((Node n) => n.attributes[TableCellBlockKeys.height]),
            ),
        ...
        TableActionHandler(
          ...
          transform: context.select((Node n) {
            ...
            double left = -12;
            for (var i = 0; i < col; i++) {
              left -= getCellNode(n.parent!, i, 0)?.attributes[TableCellBlockKeys.width] as double;
              left -= n.parent!.attributes['borderWidth'] ?? TableDefaults.borderWidth;
            }

            return Matrix4.translationValues(left, 0.0, 0.0);
          }),
          alignment: Alignment.centerLeft,
          height: context.select((Node n) => n.attributes[TableCellBlockKeys.height]),
