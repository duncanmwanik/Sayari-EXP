  ...
  overlay = FullScreenOverlayEntry(
    ...
    builder: (context) {
      return basicOverlay(
        ...
        height: 230,
        children: [
          _menuItem(context, dir == TableDirection.col ? AppFlowyEditorL10n.current.colAddBefore : AppFlowyEditorL10n.current.rowAddBefore,
              dir == TableDirection.col ? Icons.first_page : Icons.vertical_align_top, () {
            TableActions.add(node, position, editorState, dir);
            dismissOverlay();
          }),
          _menuItem(context, dir == TableDirection.col ? AppFlowyEditorL10n.current.colAddAfter : AppFlowyEditorL10n.current.rowAddAfter,
              dir == TableDirection.col ? Icons.last_page : Icons.vertical_align_bottom, () {
            TableActions.add(node, position + 1, editorState, dir);
            dismissOverlay();
          }),
          _menuItem(context, dir == TableDirection.col ? AppFlowyEditorL10n.current.colRemove : AppFlowyEditorL10n.current.rowRemove,
              Icons.delete, () {
            TableActions.delete(node, position, editorState, dir);
            dismissOverlay();
          }),
          _menuItem(context, dir == TableDirection.col ? AppFlowyEditorL10n.current.colDuplicate : AppFlowyEditorL10n.current.rowDuplicate,
              Icons.content_copy, () {
          ...
          _menuItem(
            ...
            () {
              ...
              final key = dir == TableDirection.col ? TableCellBlockKeys.colBackgroundColor : TableCellBlockKeys.rowBackgroundColor;
          ...
          _menuItem(
              context, dir == TableDirection.col ? AppFlowyEditorL10n.current.colClear : AppFlowyEditorL10n.current.rowClear, Icons.clear,
              () {
