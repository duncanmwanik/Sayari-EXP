...
Node todoListNode({
  ...
  return Node(
    ...
    attributes: {
      ...
      TodoListBlockKeys.delta: (delta ?? (Delta()..insert(text ?? ''))).toJson(),
...
class _TodoListBlockComponentWidgetState extends State<TodoListBlockComponentWidget>
  ...
  bool get checked => widget.node.attributes[TodoListBlockKeys.checked] ?? false;
          ...
          Flexible(
            child: Padding(
              ...
              child: AppFlowyRichText(
                ...
                textDirection: textDirection,
                textSpanDecorator: (textSpan) => textSpan.updateTextStyle(textStyleWithTextSpan()).updateTextStyle(
