...
///   - web
///
CharacterShortcutEvent formatEmptyBracketsToUncheckedBox = CharacterShortcutEvent(
...
///   - web
///
CharacterShortcutEvent formatHyphenEmptyBracketsToUncheckedBox = CharacterShortcutEvent(
...
///   - web
///
CharacterShortcutEvent formatFilledBracketsToCheckedBox = CharacterShortcutEvent(
...
///   - web
///
CharacterShortcutEvent formatHyphenFilledBracketsToCheckedBox = CharacterShortcutEvent(
  ...
  return formatMarkdownSymbol(
    ...
    (_, node, delta) => [
      node.copyWith(
        ...
        attributes: {
          TodoListBlockKeys.checked: false,
          TodoListBlockKeys.delta: delta.compose(Delta()..delete(symbol.length)).toJson(),
        },
      ),
    ],
  );
