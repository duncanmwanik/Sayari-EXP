...
final CharacterShortcutEvent convertMinusesToDivider = CharacterShortcutEvent(
  ...
  character: '-',
  handler: (editorState) async => await _convertSyntaxToDivider(editorState, '--') || await _convertSyntaxToDivider(editorState, '—'),
);
...
final CharacterShortcutEvent convertUnderscoreToDivider = CharacterShortcutEvent(
