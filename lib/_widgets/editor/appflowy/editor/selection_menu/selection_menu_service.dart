        ...
        return SizedBox(
          ...
          child: GestureDetector(
            ...
            child: Consumer<ThemeProvider>(builder: (context, themeProvider, child) {
              SelectionMenuStyle customStyle = SelectionMenuStyle(
                selectionMenuBackgroundColor: styler.secondaryColor(),
                selectionMenuItemTextColor: styler.textColor(faded: true),
                selectionMenuItemIconColor: styler.textColor(faded: true),
                selectionMenuItemSelectedTextColor: styler.textColor(faded: true),
                selectionMenuItemSelectedIconColor: styler.textColor(faded: true),
                selectionMenuItemSelectedColor: styler.appColor(1),
              );
                  ...
                  Positioned(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: SelectionMenuWidget(
                        selectionMenuStyle: customStyle,
