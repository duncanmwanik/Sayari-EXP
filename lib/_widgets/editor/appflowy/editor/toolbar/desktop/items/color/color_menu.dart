...
void showColorMenu(
  ...
  overlay = FullScreenOverlayEntry(
    ...
    builder: (context) {
      return ColorPicker(
        title: isTextColor ? AppFlowyEditorL10n.current.textColor : AppFlowyEditorL10n.current.highlightColor,
        showClearButton: showClearButton,
        selectedColorHex: currentColorHex,
        colorOptions:
            isTextColor ? textColorOptions ?? generateTextColorOptions() : highlightColorOptions ?? generateHighlightColorOptions(),
        ...
        resetText: isTextColor ? AppFlowyEditorL10n.current.resetToDefaultColor : AppFlowyEditorL10n.current.clearHighlightColor,
