...
final dividerMobileToolbarItem = MobileToolbarItem.action(
  ...
  actionHandler: (_, editorState) {
    ...
    if (next == null || next.type != ParagraphBlockKeys.type || next.delta?.isNotEmpty == true) {
      transaction.insertNode(insertedPath, paragraphNode());
    }
    transaction.afterSelection = Selection.collapsed(Position(path: insertedPath.next));
