...
class _BlocksMenuState extends State<_BlocksMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    final children = lists.map((list) {
      ...
      final isSelected = node.type == list.name && (list.level == null || node.attributes[HeadingBlockKeys.level] == list.level);
            ...
            widget.editorState.formatNode(
              ...
              (node) => node.copyWith(
                ...
                attributes: {
                  ...
                  if (!isSelected && list.name == TodoListBlockKeys.type) TodoListBlockKeys.checked: false,
                  if (!isSelected && list.name == HeadingBlockKeys.type) HeadingBlockKeys.level: list.level,
                },
              ),
              selectionExtraInfo: {
