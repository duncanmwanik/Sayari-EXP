...
import '../../../../flutter/scrollable_positioned_list/scrollable_positioned_list.dart';
import '../../../../flutter/scrollable_positioned_list/src/item_positions_notifier.dart';
...
class EditorScrollController {
  ...
  void dispose() {
    ...
    if (!shrinkWrap) {
      ...
      (_itemPositionsListener as ItemPositionsNotifier?)?.itemPositions.dispose();
    }
  ...
  void _listenItemPositions() {
    ...
    if (editorState.showFooter && max >= editorState.document.root.children.length) {
      max--;
    }
