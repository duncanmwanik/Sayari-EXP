...
class _ScrollServiceWidgetState extends State<ScrollServiceWidget> implements AppFlowyScrollService {
  ...
  void _onSelectionChanged() {
    ...
    if (selection == null ||
        [SelectionUpdateReason.selectAll, SelectionUpdateReason.searchHighlight].contains(editorState.selectionUpdateReason)) {
      return;
    }
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (PlatformExtension.isMobile) {
        ...
        final duration = KeyboardHeightObserver.currentKeyboardHeight == 0 ? const Duration(milliseconds: 250) : Duration.zero;
