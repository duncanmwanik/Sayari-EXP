...
mixin NestedBlockComponentStatefulWidgetMixin<T extends BlockComponentStatefulWidget> on State<T>, BlockComponentBackgroundColorMixin {
  ...
  @override
  Widget build(BuildContext context) {
    return node.children.isEmpty ? buildComponent(context, withBackgroundColor: true) : buildComponentWithChildren(context);
  }
