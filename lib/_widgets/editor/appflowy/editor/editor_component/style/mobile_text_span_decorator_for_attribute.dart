...
class _LinkEditFormState extends State<LinkEditForm> {
  ...
  Widget build(BuildContext context) {
    var hrefAddressTextEditingController = TextEditingController(text: widget.hrefAddress);
    var hrefTextTextEditingController = TextEditingController(text: widget.hrefText);
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    final bool textChanged = hrefTextTextEditingController.text != widget.hrefText;
                    final bool addressChanged = hrefAddressTextEditingController.text != widget.hrefAddress;
                    ...
                    if (textChanged && addressChanged) {
                      final transaction = widget.editorState.transaction
                        ..replaceText(
                          ...
                          attributes: {
                            AppFlowyRichTextKeys.href: hrefAddressTextEditingController.text,
                          },
                        );
                      await widget.editorState.apply(transaction).whenComplete(
                        () {
