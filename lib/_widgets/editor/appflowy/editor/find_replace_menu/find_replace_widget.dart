...
class FindAndReplaceMenuWidget extends StatefulWidget {
  ...
  @override
  State<FindAndReplaceMenuWidget> createState() => _FindAndReplaceMenuWidgetState();
}
...
class _FindMenuState extends State<FindMenu> {
    ...
    return Row(
      children: [
        ...
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.previousMatch ?? AppFlowyEditorL10n.current.previousMatch,
        ),
        // next match button
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.nextMatch ?? AppFlowyEditorL10n.current.nextMatch,
        ),
        FindAndReplaceMenuIconButton(
          iconButtonKey: const Key('closeButton'),
          onPressed: widget.onDismiss,
          icon: const Icon(Icons.close),
          tooltip: widget.localizations?.close ?? AppFlowyEditorL10n.current.closeFind,
        ),
        // regex button
        if (showRegexButton)
          FindAndReplaceMenuIconButton(
        ...
        if (showCaseSensitiveButton)
          FindAndReplaceMenuIconButton(
            ...
            icon: EditorSvg(
              ...
              width: 20,
              height: 20,
              color: widget.searchService.caseSensitive ? Colors.black : Colors.grey,
            ),
  ...
  void _searchPattern() {
    ...
    switch (error) {
      ...
      default:
        message = widget.localizations?.noResult ?? AppFlowyEditorLocalizations.current.noFindResult;
    }
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: _buildInputDecoration(
              widget.localizations?.replace ?? AppFlowyEditorL10n.current.replace,
            ),
          ),
        ),
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.replace ?? AppFlowyEditorL10n.current.replace,
        ),
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.replaceAll ?? AppFlowyEditorL10n.current.replaceAll,
        ),
      ],
    );
  }
