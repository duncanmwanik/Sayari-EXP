...
final class Node extends ChangeNotifier with LinkedListEntry<Node> {
  ...
  void checkDocumentIntegrity() {
    ...
    if (path.isNotEmpty) {
      ...
      final errorMessage = '''Please submit an issue to https://github.com/AppFlowy-IO/appflowy-editor/issues if you see this error!
          node = ${toJson()}''';
      assert(
        parent != null,
        errorMessage,
...
extension NodeEquality on Iterable<Node> {
  ...
  bool _nodeEquals<T, U>(T base, U other) =>
      identical(this, other) || base is Node && other is Node && other.type == base.type && other.children.equals(base.children);
}
