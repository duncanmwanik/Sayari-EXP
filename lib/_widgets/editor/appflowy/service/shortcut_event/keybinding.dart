  ...
  bool containsKeyEvent(KeyEvent keyEvent) {
    for (final keybinding in this) {
      if (keybinding.isMetaPressed == HardwareKeyboard.instance.isMetaPressed &&
          keybinding.isControlPressed == HardwareKeyboard.instance.isControlPressed &&
          keybinding.isAltPressed == HardwareKeyboard.instance.isAltPressed &&
          keybinding.isShiftPressed == HardwareKeyboard.instance.isShiftPressed &&
...
class Keybinding {
  ...
  factory Keybinding.parse(String command) {
    ...
    do {
      ...
      if (RegExp(r'^cmd(\+|\-)').hasMatch(command) || RegExp(r'^win(\+|\-)').hasMatch(command)) {
        isMetaPressed = true;
  ...
  factory Keybinding.fromJson(String source) => Keybinding.fromMap(json.decode(source));
  ...
  @override
  int get hashCode {
    return isAltPressed.hashCode ^ isControlPressed.hashCode ^ isMetaPressed.hashCode ^ isShiftPressed.hashCode ^ keyCode;
  }
}
