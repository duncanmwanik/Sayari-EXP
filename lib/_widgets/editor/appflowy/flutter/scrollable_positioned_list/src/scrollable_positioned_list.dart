...
class ScrollOffsetController {
  ...
  void jumpTo({required double offset}) => _scrollableListState!.primary.scrollController.jumpTo(offset);
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    ItemPosition? initialPosition = PageStorage.maybeOf(context)?.readState(context);
    ...
    if (itemPositions.isNotEmpty) {
      PageStorage.maybeOf(context)?.writeState(
        ...
        itemPositions.reduce(
          (value, element) => value.itemLeadingEdge < element.itemLeadingEdge ? value : element,
        ),
      );
    }
