...
import 'mobile_basic_handle.dart';
...
class _IOSCollapsedHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final widthExtend = editorStyle.mobileDragHandleWidthExtend ?? 2 * defaultExtend;
    final heightExtend = editorStyle.mobileDragHandleHeightExtend ?? 2 * defaultExtend;
...
class _AndroidCollapsedHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final leftExtend = editorStyle.mobileDragHandleLeftExtend ?? 2 * handleBallWidth;
    final widthExtend = editorStyle.mobileDragHandleWidthExtend ?? 4 * handleBallWidth;
    final heightExtend = editorStyle.mobileDragHandleHeightExtend ?? 2 * handleBallWidth;
    final adjustedRect = Rect.fromLTWH(
      rect.left - leftExtend,
      rect.top - topExtend,
      rect.width + widthExtend,
