...
Map<String, ColorObject> backgroundColors = {
  ...
  '5': ColorObject(color: Colors.teal, shadeColor: Colors.teal.shade200, textColor: Colors.black),
  '6': ColorObject(color: Colors.purple, shadeColor: Colors.purple.shade200, textColor: Colors.white, isTheme: true),
  '7': ColorObject(color: Colors.brown, shadeColor: Colors.brown.shade200, textColor: Colors.white),
